...
CachePolicy.RegisterFieldPolicy('postItems', startLimitPagination(['where', ['Catalog', ['id', 'Slug']]]));
CachePolicy.RegisterFieldPolicy('textFields', startLimitPagination(['where', 'Name']));
